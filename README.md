...
$$
U_A = U_B = \frac{1}{\sqrt{2}}\begin{pmatrix}
1 & -1 \\
-1 & -1
\end{pmatrix}
$$
...
| **Subsystem Correlation** | Independent ($P(q\_1, q\_0) = P(q\_1)P(q\_0)$) | Deterministic Parity Correlation ($q_1 = q_0$) |
...
- 5 qubits: $2^5 = 32$ basis states ($\{ |00000\rangle, \dots, |11111\rangle \}$)  
